    ...
    public static class Main {
        ...
        private void menu(){
            do {
                ...
                System.out.println("2) Crear Modelo.PagoEfectivo.Bus");
        ...
        private void createBus(){
            ...
            if (sv.createBus(patente, marca, modelo, asientos)) {
                System.out.println("...::::Modelo.PagoEfectivo.Bus guardado exitosamente:::...");
            }
            else {
        ...
        private void createViaje() {
            ...
            else System.out.println("...::::modelo.Terminal.Viaje guardado exitosamente::::...");
        }
