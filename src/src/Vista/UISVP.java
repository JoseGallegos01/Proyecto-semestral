...
public class UISVP {
    ...
    public void menu(){
        do {
            ...
            System.out.println("5) Crear Modelo.PagoEfectivo.Bus");
    ...
    private void contratarTripulante(){
        ...
        try {
            ...
            System.out.println("Modelo.Modelo.Pago.Auxiliar[1] o conductor[2]");
    ...
    private void createBus(){
        ...
        sv.createBus(patente, marca, modelo, asientos);
            System.out.println("...::::modelo.Modelo.PagoEfectivo.Bus guardado exitosamente:::...");
        } catch (SistemaVentaPasajesException e){
    ...
    private void createViaje() {
        ...
        try {
            ...
            System.out.println("...::::modelo.Terminal.Viaje guardado exitosamente::::...");
        }catch (SistemaVentaPasajesException e){
    ...
    private void vendePasajes(){
        System.out.println("...::::modelo.TipoDocumento.Venta de pasajes::::...");
