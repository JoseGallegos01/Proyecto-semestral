...
public class UISVP {
    ...
    private void vendePasajes() {
        try{
            ...
            if (sv.getHorariosDisponibles(LocalDate.parse(fechaViaje, formatterDate)).length == 0) throw new SistemaVentaPasajesException("No se encontraron viajes disponibles");
